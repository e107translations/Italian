...
define("GSLAN_8", "Importare con:");
define("GSLAN_9", "Priorità");
define("GSLAN_10", "Frequenza");
define("GSLAN_11", "sempre");
define("GSLAN_12", "oraria");
define("GSLAN_13", "tutti i giorni");
define("GSLAN_14", "settimanale");
define("GSLAN_15", "mensile");
define("GSLAN_16", "annuale");
define("GSLAN_18", "Importare collegamenti barrati");
define("GSLAN_20", "Profilo");
define("GSLAN_21", "Istruzioni");
define("GSLAN_22", "Creare la nuova voce");
define("GSLAN_23", "Importazione");
define("GSLAN_24", "Voci di Google Sitemap");
define("GSLAN_27", "Lastmod");
define("GSLAN_28", "Freq.");
define("GSLAN_29", "Configurazione di Google Sitemap");
define("GSLAN_32", "Come utilizzare Google Sitemaps");
define("GSLAN_33", "GSiteMap istruzioni");
