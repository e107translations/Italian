...
define("LAN_UPDATE_28", "[x] salvato e-mail spostata");
...
define("LAN_UPDATE_37", "Aggiungi indice [x] a tavola [y]");
...
define("LAN_UPDATE_54", "Tabella mancante [y] non è possibile aggiungere indice [x]");
...
define("LAN_UPDATE_58", "Si consiglia vivamente di eseguire [Ispezione FIles] dopo aver completato tutti gli aggiornamenti, per rilevare eventuali file obsoleti che devono essere rimossi.");
